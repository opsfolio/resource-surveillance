...
#[derive(Debug, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct UrIngestSessionImapAcctFolderMessageAttachment {
    ur_ingest_session_imap_acct_folder_message_attachment_id: String, // PRIMARY KEY ('string' maps directly to Rust type)
    ingest_session_id: String, // 'string' maps directly to Rust type
