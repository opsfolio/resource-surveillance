...
SET udi_pgp_serve_ncl_supplier = '
  let hetzner-atc = {
    type = "osquery",
    mode = "local",
    atc-file-path = "/home/niba/workspaces/git.netspective.io/netspective-infrastructure/assurance/hetzner/hetzner.omc.sqla.osquery-atc.json",
    auth = [
      {
        username = "opsfolio",
        password = "UwbJMg6Cx",
...
SELECT * FROM person;
 ...
 select issue, source, cause_of_the_issue, testing_analysis, solution, modification_of_the_reported_issue, testing_for_modified_issue, test_results, probability_of_issue, likelihood_of_risk from root_cause_analysis_view;
